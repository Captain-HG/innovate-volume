...
public class WebConst {
   ...
   //UserInfo的类型
    ...
    //合同类型
    public static  final String CONTRACT_SIHGLE="单务";
    public static  final String CONTRACT_DOUBLE="双务";
    public static  final String CONTRACT_PAID="有偿";
    public static  final String CONTRACT_FREE="无偿";
